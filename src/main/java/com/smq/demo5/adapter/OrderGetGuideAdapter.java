...
public class OrderGetGuideAdapter extends BaseAdapter {

    GetGuideFragment context;
    List<MyOrderEntity> list;
    public OrderGetGuideAdapter(GetGuideFragment context, List<MyOrderEntity> list){
